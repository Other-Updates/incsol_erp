    ...
    <?php if ($this->user_auth->is_section_allowed('service', 'service')) { ?>
        <div class="col-xl-3 col-md-6">
            <div class="card">
                ...
                <a href="<?php echo $this->config->item('base_url') . 'service/service_list' ?>">
    ...
    <?php if ($this->user_auth->is_section_allowed('project_cost', 'project_cost')): ?>
       ...
       <div class="col-md-12 col-lg-12">
            <div class="card">
                ...
                <select class="form-control year pull-right" id="yearchange" style="width:8%;">
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <span>Quotation Vs Project Cost</span>
                </div>
                <div class="card-block">
           ...
           var year = $("select.year").val();
               $.ajax({
                    ...
                    success: function (data) {
                        ...
                        service_graph(pending, completed, month);
                    }
                });
           }
    function service_graph(pending, completed, month) {
        var data1 = {
            labels: month,
            datasets: [{
           ...
           year = $("select.year").val();
            $.ajax({
                ...
                success: function (data1) {
                    var jsonData = $.parseJSON(data1);
                    var arr = new Array();
                    arr.push(['Month', 'Quotation', 'Project Cost']);
