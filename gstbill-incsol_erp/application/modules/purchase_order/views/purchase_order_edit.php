                                    ...
                                    <div class="col-md-3">
                                        <div class="material-group">
                                            ...
                                            <div class="form-group form-primary">
                                                ...
                                                <span class="error_msg text-danger"></span>
                                                <input type="hidden"  name="supplier[id]" id="customer_id" class='form-control id_customer tabwid' value="<?php echo $val['vendor']; ?>" />
                                    ...
                                    <div class="col-md-3">
                                        <div class="material-group">
                                            ...
                                            <div class="form-group form-primary">
                                                ...
                                                <input id="dropper-default" name="po[created_date]" tabindex="2" data-date="" data-month="" data-year="" value="<?php echo date('d-m-Y',strtotime($val['created_date'])); ?>" class="form-control form-align required" type="text" placeholder="" />
                                                <span class="form-bar"></span>
                                                <span class="error_msg text-danger"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="material-group">
                                                ...
                                                <div class="form-group form-primary">
                                                    ...
                                                    <textarea name="po[remarks]"   class="form-control remark" tabindex="5" ><?php echo $val['remarks']; ?></textarea>
                                                    <span class="form-bar"></span>
                                                </div>
                                            </div>
                                        </div>
