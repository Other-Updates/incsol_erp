...
<div class="card">
    ...
    <div class="card-header">
        <h5>View Purchase Payment Receipt
        </h5>
    </div>
    <?php
    ...
    <div class="card-block table-border-style">
        ...
        <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline">
            <thead>
            <td class="action-btn-align" colspan="4">Vendor Invoice Details</td>
            </thead>
            <tr>
                <td class="text-left" style="white-space: unset;width: 50%;"><span  class="f-w-700">PO NO:</span><?= $receipt_details[0]['po_no'] ?><br>
                    <span  class="f-w-700">GRN NO:</span>  <?php
            ...
            <tr>
                ...
                <?php } else { ?>
                    <td></td>
                <?php } ?>
                <td class="text-left"><span  class="f-w-700">Balance:</span><?php echo number_format($over_all_net_total - ($dis + $paid), 2, '.', ','); ?></td>

            </tr>
        </table>
        <div class="table-responsive" id='result_div'>
            <table class="table table-striped table-bordered responsive dataTable no-footer dtr-inline m-t-5" style="border: 1px solid #dee2e6;">
                <thead>
                <td colspan="8">Payment History</td>
                </thead>
                <thead>
...
//                                        echo "RTGS";
                                ...
                                <td class="text-right"><?= number_format($val['bill_amount'], 2, '.', ',') ?></td>
                                <td class="text-right"><?= number_format($val['discount'], 2, '.', ',') ?> ( <?= $val['discount_per'] ?> %)</td>
                                <th><?= $val['remarks'] ?></th>
                            </tr>
                            <?php
                            $i++;
            ...
            <div class="hide_class text-center m-t-10">
                <a href="<?php echo $this->config->item('base_url') ?>purchase_receipt/receipt_list"class="btn btn-inverse btn-sm waves-effect waves-light"> Back </a>
